...
namespace PROYECTO_FINAL.Controllers
{
    ...
    public class ArticuloController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="idarticulo,idcategoria,codigo,nombre,stock,descripcion,imagen,estado,price")] articulo articulo,HttpPostedFileBase file)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="idarticulo,idcategoria,codigo,nombre,stock,descripcion,imagen,estado,price")] articulo articulo,HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                if (file != null)
